    ...
    <div className="mb-8">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-6">
        <p className="text-yellow-800">
          <strong>Tip:</strong> Demonstrate soft skills through specific
          examples and achievements in your work experience.
        </p>
      </div>
      ...
      <Section
        ...
        items={[
          ...skills.identified.map((skill) => ({
            ...
            message: `Demonstrated skill: ${skill.skill} - ${
              skill.evidence || ""
            }`,
          })),
          ...skills.missing.map((skill) => ({
            ...
            message: `Consider adding: ${skill.skill} - ${
              skill.suggestion || ""
            }`,
          })),
        ]}
